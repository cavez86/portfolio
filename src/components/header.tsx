...
export const Header = () => (
  <header className="dark bg-background/50 sticky -top-18 z-50 flex flex-wrap items-center justify-between gap-2 rounded-lg px-6 py-4 backdrop-blur-xl md:top-0">
