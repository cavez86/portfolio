...
const LanguagesSection = () => (
  <Section contentClassName="max-w-3xl">
    ...
    >
      <h2 className="mb-4 text-3xl font-bold text-slate-900 md:text-4xl dark:text-white">Languages</h2>
      <p className="text-lg text-slate-600 dark:text-slate-400">Communication skills across multiple languages</p>
    </motion.div>
